...
% VERSION:      1.0
%
% NOTES:        Requires 'cpp_codebook.bin' to be present in the working 
%               directory. Validates the C++ Walsh-Hadamard implementation 
...
for i = 0:(total_masks - 1)
    % Call the mask generation function
...
if fileID == -1
    error('Could not open cpp_codebook.bin. Ensure the C++ script has been executed.');
end
